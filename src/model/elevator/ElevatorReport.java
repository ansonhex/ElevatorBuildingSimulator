...
public class ElevatorReport {
   ...
   *
   * @param elevatorId       The id of the model.elevator.
   * @param currentFloor     The current floor of the model.elevator.
   * @param doorClosed       The status of the door.
   * @param floorRequests    The requests for the floors.
   * @param direction        The direction of the model.elevator.
   * @param doorOpenTimer    The timer for the door.
   * @param endWaitTimer     The timer for the end of the run.
   * @param outOfService     The status of the model.elevator.
   * @param isTakingRequests Is the model.elevator taking requests.
   */
  ...
  /**
   * This method is used to get the id of the model.elevator.
   *
   * @return The id of the model.elevator.
   */
  ...
  /**
   * This method is used to get the current floor of the model.elevator.
   *
  ...
  /**
   * This method is used to get the direction of the model.elevator.
   *
   * @return The direction of the model.elevator.
   */
  ...
  /**
   * This method is used to get the status of the model.elevator.
   *
   * @return The status of the model.elevator.
   */
  ...
  /**
   * Is the model.elevator taking requests.
   *
   * @return is the model.elevator taking requests.
   */
  ...
  public String toString() {
    ...
    // if the model.elevator is out of service and on the ground floor
